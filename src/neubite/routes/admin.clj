...
(defroutes admin-routes
  (context "" {params :params :as request}
    (GET "/admin/edit/page/:id/"      [] (superuser-only edit-flatpage request params))
    (POST "/admin/edit/page/:id/"     [] (superuser-only edit-flatpage request params))
    (GET "/admin/write/flatpage/"     [] (superuser-only make-flatpage request params))
    (POST "/admin/write/flatpage/"    [] (superuser-only make-flatpage request params))
    (POST "/admin/publish/:coll/:id/" [] (superuser-only publish request params))
    (POST "/admin/delete/:coll/:id/"  [] (superuser-only delete request params))
    (GET  "/admin/write/"             [] (superuser-only write request params))
    (POST "/admin/write/"             [] (superuser-only write request params))
    (GET  "/admin/edit/post/:id/"     [] (superuser-only edit-post request params))
    (POST  "/admin/edit/post/:id/"    [] (superuser-only edit-post request params))
    (GET  "/admin/"                   [] (superuser-only admin-home request params))))
